...
export default async function ComponentPage({ params }: { params: Promise<{ library: Library, component: ComponentId }> }) {
    ...
    if (!library) {
        ...
        return ( // Show a loading state while params are being resolved
